 ...
 */
bool first_phase_process(*full_filename)
{
...
/**
 * @brief Processes a single line in the first pass
 ...
 */
static bool line_process(line_info line, long *IC, long *DC, machine_word **code_img, long *data_img,
                        table *symbol_table) {
	int i, j;
